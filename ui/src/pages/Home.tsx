...
const SUGGESTIONS: { query: string, shortName: string }[] = [
  { query: 'How can we improve mental health outcomes and reduce substance misuse among displaced communities in Ethiopia?', shortName: 'How can we improve mental health outcomes and reduce substance misuse among displaced communities in Ethiopia?' },
            ...
            >
              {SUGGESTIONS.map((suggestion) => (
                <Grid item key={suggestion.query}>
                  <SuggestedPrompt onClick={() => handleSubmit(suggestion.query, cookieUserId, true)}>
