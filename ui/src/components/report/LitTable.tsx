  ...
  return (
    <TableContainer sx={{ padding: 0 }}>
      ...
      >
        ...
        >
          <ViewListOutlinedIcon fontSize="small" sx={{ marginRight: '4px' }} />
        ...
        {columnChunks.length > 1 && (
          <Box sx={{ alignItems: 'center', display: 'flex', gap: '8px' }}>
            ...
            <ButtonGroup
              ...
              sx={{ border: '1px solid rgba(240, 82, 156, 0.5)' }}
            >
      ...
      <Table size="small">
        ...
        <TableBody>
          {rows.map((row) => {
            const detail = row.paper_corpus_id
              ? corpusId2Citation?.[row.paper_corpus_id]?.paper
              : undefined;
            ...
            return (
              ...
              >
                ...
                {selectedColumns.map((column) => {
                  ...
                  return <CellWithEvidence cell={cell} key={column.id} />;
                })}
              </TableRow>
            );
          })}
