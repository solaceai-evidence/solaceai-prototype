...
export const Sidebar: React.FC<PropType> = (props) => {
  const { mobileOpen, handleDrawerTransitionEnd, handleDrawerClose, drawerWidth, history, setHistory } = props;
  ...
  const drawer = (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: {xs:'100vh', sm:'100%'}, backgroundColor: 'rgba(250,242,233,0.04)'}}>

      <Box sx={{ borderBottom: '1px solid rgba(250, 242, 233, 0.1)' }}>
        <Button href="/" variant="text" sx={{ display: 'flex', justifyContent: 'flex-start', lineHeight: '40px', padding:'8px 18px'   }} startIcon={<AddIcon />} color="secondary" size="large">
          Ask A New Question
        </Button>
      </Box>

      <Typography variant="h6" sx={{ margin: '16px 18px 0 18px', fontWeight: 'bold' }}>Recent Questions</Typography>
      <List
        sx={{
          overflow: 'auto',
          flexGrow: '1'
            ...
            <ListItem key={item.taskId} sx={{ padding:'0 4px' }}>
              <ListItemButton
                ...
                sx={{
                  ...
                  backgroundColor: selected ? 'rgba(250, 242, 233, 0.04) !important' : 'transparent',
                  borderRadius: '4px',
                  display: 'flex',
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', paddingBottom: '4px' }}>
          <Link href="https://www.semanticscholar.org" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 557.7 100">
              <path fill="#F8F0E7" d="M179.4,40.5c-.1.2-.2.4-.4.5-.2.1-.4.2-.6.2-.3,0-.6-.1-.8-.3-.3-.2-.7-.5-1.2-.7-.5-.3-1.1-.6-1.7-.8-.7-.2-1.5-.3-2.3-.3-.8,0-1.5,0-2.2.3-.6.2-1.1.5-1.6.9-.4.4-.8.8-1,1.3-.2.5-.3,1.1-.3,1.7,0,.7.2,1.4.6,1.9.4.5,1,1,1.6,1.3.7.4,1.4.7,2.2,1l2.5.8c.9.3,1.7.6,2.5,1,.8.4,1.5.8,2.2,1.4.7.6,1.2,1.3,1.6,2.1.4.9.6,2,.6,3,0,1.2-.2,2.4-.6,3.6-.4,1.1-1.1,2.1-1.9,2.9-.9.9-1.9,1.6-3.1,2-1.3.5-2.7.7-4.1.7-1.8,0-3.5-.3-5.2-1-.8-.3-1.5-.7-2.2-1.2-.7-.5-1.3-1-1.8-1.6l1.2-2c.1-.2.3-.3.4-.4.2-.1.4-.2.6-.2.4,0,.7.2,1,.5.4.3.8.6,1.4,1,.6.4,1.3.7,2,1,.9.3,1.8.5,2.8.4.8,0,1.6-.1,2.4-.3.7-.2,1.3-.5,1.8-1,.5-.4.9-1,1.1-1.6.3-.7.4-1.3.4-2,0-.7-.2-1.5-.6-2.1-.4-.6-1-1.1-1.6-1.5-.7-.4-1.4-.7-2.2-.9l-2.5-.8c-.9-.3-1.7-.6-2.5-1-.8-.3-1.5-.8-2.2-1.4-.7-.6-1.2-1.4-1.6-2.2-.4-1-.6-2.1-.6-3.3,0-2.1.8-4.1,2.4-5.6.8-.8,1.8-1.4,2.9-1.8,1.2-.5,2.5-.7,3.9-.7,1.5,0,3,.2,4.5.8,1.3.5,2.5,1.3,3.6,2.2l-1,2.1Z" />
              <path fill="#F8F0E7" d="M203.7,61.2v3.5h-17.9v-28.9h17.9v3.5h-13.6v9.2h11v3.4h-11v9.4h13.7Z" />
              <path fill="#F8F0E7" d="M238.2,35.8v28.9h-3.7v-21.6c0-.3,0-.7,0-1.1l-9.6,17.7c-.3.6-.9,1-1.6,1h-.6c-.7,0-1.3-.4-1.5-1l-9.8-17.7c0,.7.1,1.4.1,2.1v20.6h-3.8v-28.9h3.2c.3,0,.6,0,.9.1.3.1.5.3.6.6l9.7,17.3c.2.3.4.7.5,1.1s.3.8.5,1.2c.3-.8.6-1.5,1-2.3l9.5-17.3c.1-.3.3-.5.6-.6.3,0,.6-.1.9-.1h3.2Z" />
              <path fill="#F8F0E7" d="M268.7,64.7h-3.3c-.3,0-.7,0-.9-.3-.2-.2-.4-.4-.5-.7l-2.6-6.7h-12.8l-2.6,6.7c-.1.3-.3.5-.5.7-.3.2-.6.3-.9.3h-3.3l11.5-28.9h4.3l11.5,28.9ZM260.2,53.9l-4.3-11.2c-.4-1-.7-1.9-.9-2.9-.1.6-.3,1.1-.4,1.6s-.3.9-.4,1.3l-4.3,11.2h10.4Z" />
              <path fill="#F8F0E7" d="M295.5,35.8v28.9h-2.2c-.3,0-.6,0-.8-.2-.3-.2-.5-.4-.7-.6l-16.3-21.1c0,.4,0,.7,0,1.1s0,.7,0,1v19.8h-3.8v-28.9h2.2c.3,0,.6,0,.9.1.3.1.5.3.6.6l16.4,21.2c0-.4,0-.8,0-1.1v-20.7h3.8Z" />
    ...
    <>
      <Drawer
        ...
        sx={{
          ...
          '& .MuiDrawer-paper': { 
            boxSizing: 'border-box', backgroundColor: {xs:'#08232B', sm:'rgba(250, 242, 233, 0.04)'}, color: '#F8F0E7', width: {xs: '80vw', sm: '240px'} },
        }}
      >
        {drawer}
      </Drawer>
      <Drawer
        ...
        sx={{
          ...
          flexShrink: 0,
          '& .MuiDrawer-paper': { boxSizing: 'border-box', backgroundColor: {xs:'#08232B', sm:'rgba(250, 242, 233, 0.04)'}, color: '#F8F0E7', width: {xs: '80vw', sm: '240px'} },
        }}
        open
      >
        {drawer}
