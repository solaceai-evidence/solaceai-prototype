  ...
  return (
    <Card
      sx={{
        ...
        border: '1px solid rgba(250, 242, 233, 0.6)',
        color: '#FAF2E9',
        borderRadius: '8px',
      }}
    >
          ...
          <>
            <Typography variant="h6" component="pre" pl={3}>
              ...
              <Typography variant="h6" component="div" pl={3}>
                <ErrorBoundary fallback={<span>...</span>}>
                  <TimeEstimate
                    estimatedTime={runningStep.estimated_timestamp}
                    startTime={runningStep.start_timestamp}
                  />
                </ErrorBoundary>
              </Typography>
            </Typography>
      ...
      <CardMedia component="div" sx={{ width: 60, minWidth: 60 }}>
        {!error ? (
          <CircularProgress />
        ) : (
