...
# ModalReranker example (commented out)
...
# Use RemoteReranker to connect to the high-performance reranker service
reranker = RemoteReranker(service_name="reranker", batch_size=256)
